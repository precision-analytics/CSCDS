...
This presentation & R code can be found on [Github](https://github.com/precision-analytics/CSCDS)

```{r r_logo, out.width = "20%", fig.align='center'}
...
Unless it's about the R vs Python debate {#questions}
============================================
